...
qc.x([7])
qc.cp(-2.6998062,[7], [0])
qc.cp(0.88357293,[7], [1])
qc.cp(1.7671458676442586,[7], [2])
qc.cp(-2.748893571891069,[7], [3])
qc.cp(0.7853981633974483,[7], [4])
qc.cp(1.5707963267948966,[7], [5])
qc.cp(3.141592653589793,[7], [6])
qc.swap([0], [6])
qc.h([0])
qc.swap([1], [5])
