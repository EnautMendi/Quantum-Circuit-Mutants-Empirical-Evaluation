...
qc.h([9])
qc.x([10])
qc.cp(-2.6936703,[10], [0])
qc.cp(0.89584478,[10], [1])
qc.cp(1.7916896,[10], [2])
qc.cp(-2.6998062,[10], [3])
qc.cp(0.88357293,[10], [4])
qc.cp(1.7671458676442586,[10], [5])
qc.cp(-2.748893571891069,[10], [6])
qc.cp(0.7853981633974483,[10], [7])
qc.cp(1.5707963267948966,[10], [8])
qc.cp(3.141592653589793,[10], [9])
qc.swap([0], [9])
qc.h([0])
qc.swap([1], [8])
