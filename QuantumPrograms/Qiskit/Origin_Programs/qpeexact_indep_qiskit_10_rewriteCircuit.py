...
qc.x([9])
qc.cp(-2.6998062,[9], [0])
qc.cp(0.88357293,[9], [1])
qc.cp(1.7671458676442586,[9], [2])
qc.cp(-2.748893571891069,[9], [3])
qc.cp(0.7853981633974483,[9], [4])
qc.cp(1.5707963267948966,[9], [5])
qc.cp(3.141592653589793,[9], [6])
qc.swap([0], [8])
qc.h([0])
qc.swap([1], [7])
