...
qc.x([8])
qc.cp(-2.6998062,[8], [0])
qc.cp(0.88357293,[8], [1])
qc.cp(1.7671458676442586,[8], [2])
qc.cp(-2.748893571891069,[8], [3])
qc.cp(0.7853981633974483,[8], [4])
qc.cp(1.5707963267948966,[8], [5])
qc.cp(3.141592653589793,[8], [6])
qc.swap([0], [7])
qc.h([0])
qc.swap([1], [6])
