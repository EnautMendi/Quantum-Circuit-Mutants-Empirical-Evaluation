...
qc.u(0.92729522,0.0,0.0,[5])
qc.cx([0], [5])
qc.u(-0.92729522,0.0,0.0,[5])
qc.cx([0], [5])
qc.u(0.92729522,0.0,0.0,[5])
qc.cx([1], [5])
qc.u(-1.8545904,0.0,0.0,[5])
qc.cx([1], [5])
qc.u(1.8545904,0.0,0.0,[5])
qc.cx([2], [5])
qc.u(-3.7091809,0.0,0.0,[5])
qc.cx([2], [5])
qc.u(2.5740044,-3.141592653589793,-3.141592653589793,[5])
qc.cx([3], [5])
qc.u(-7.4183617,0.0,0.0,[5])
qc.cx([3], [5])
qc.u(1.1351764,0.0,0.0,[5])
qc.cx([4], [5])
qc.u(-14.836723,0.0,0.0,[5])
qc.cx([4], [5])
qc.u(14.836723,0.0,0.0,[5])
qc.h([4])
